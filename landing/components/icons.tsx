/**
 * Feather-style line icons, matching the set the app uses through
 * @expo/vector-icons. 24x24, 2px stroke, currentColor.
 */
type IconProps = {
    className?: string;
    size?: number;
...
export const CardIcon = ({ className, size = 20 }: IconProps) => (
    <svg {...base(size)} className={className}>
